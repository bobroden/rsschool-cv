...
3. 2023-2026: ICS RAS. Mathematical and software support of computer systems, complexes and computer networks - Postgraduate's degree.

* 2020 - Immersion in Python (Coursera);
* 2020 - JavaScript, Part 1: Basics and Functions (Coursera);
* 2020 - RS 2020 Q1 (RS-School);
* 2021 - Frontend Angular development (Netcracker, N. I. Lobachevsky National Research University);
* 2022 - Frontend development (Netcracker).
---
### Languages
* English - B1;
* Russian - C2 (native);
